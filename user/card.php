                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-4 mt-4">
                                                ...
                                                <div class="input-group">
                                                    <textarea class="form-control mb-4" rows="3" id="textarea-copy" placeholder="Request Reason" name="card_reason" ><?= htmlspecialchars($_POST['card_reason'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
