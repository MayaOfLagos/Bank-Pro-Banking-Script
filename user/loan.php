       ...
       notify_alert('Amount Required','info','3000','Close');
        ...
        $stmt->execute([
            ...
            'loan_remarks' => $loan_remarks
                            ...
                            $email_message->send_to_both($email, $message, "Loan Status - $APP_NAME");
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <span class="input-group-text" id="basic-addon1"><svg
                                                        ...
                                                        <input type="number" class="form-control" name="amount" value="<?= htmlspecialchars($_POST['amount'] ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="Amount" aria-label="notification" aria-describedby="basic-addon1" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <textarea class="form-control mb-4" rows="3" id="textarea-copy" placeholder="Loan Description" name="loan_remarks" ><?= htmlspecialchars($_POST['loan_remarks'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
