...
if (isset($_POST['save_settings'])) {
    ...
    // server side too — the input has max=10000000 but a hand-crafted
    // POST could bypass that. Keep the cap identical on both sides.
    ...
    // Normalise the free-text domain/country lists before saving:
    //  * strip stray whitespace, collapse commas
    //  * lowercase domains, uppercase ISO codes
    //  * drop entries that don't look right (protects the API from having
    //    to defend against garbage rows and gives the admin visible
    //    feedback about what actually got saved).
