...
$systemPages   = ['audit-log.php', 'system-health.php', 'db-backup.php', 'notifications.php'];
?>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?= $open($systemPages) ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"><a href="./notifications.php" class="nav-link <?= $active('notifications.php') ?>"><i class="far fa-circle nav-icon"></i><p>Notifications<?php if (!empty($bellUnreadCount)): ?><span class="badge badge-warning right"><?= (int)$bellUnreadCount ?></span><?php endif; ?></p></a></li>
